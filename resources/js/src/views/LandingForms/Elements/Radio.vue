<template>
    <b-card no-body class="mb-1 iq-accordion-block">
        <b-card-header header-tag="header" class="py-1 col-12 border-0" role="tab">
           <span style="line-height: 2.2;color:black">{{field.label ? field.label: 'Radio Box'}}</span>
            ...
            <b-card-body>
                <div class="border py-3 rounded mx-0 ">
                 ...
                 <b-form-group
                        ...
                        label-cols-sm="2"
                        label="Required"
                        label-for="radio_field_required[]" >
                        <b-form-checkbox name="radio_field_required[]" class="mt-2"
                    ...
                    <b-form-group
                        ...
                        label-cols-sm="2"
                        label="Input Label"
                        label-for="radio_field_label[]" >
                        <ValidationProvider :name="'radio_field_label'+counter" rules="required" v-slot="{ errors }">
                            <b-form-input name="radio_field_label[]" placeholder="Label for the input" 
                            v-model="field.label"
                    ...
                    <b-form-group
                        ...
                        label-cols-sm="2"
                        label="Hide Label"
                        label-for="radio_field_hide_label[]" >
                     
                        <b-form-checkbox name="radio_field_hide_label[]" class="mt-2"
                    ...
                    <b-form-group
                        ...
                        label-cols-sm="2"
                        label="Placeholder"
                        label-for="radio_field_placeholder[]" >
                        <ValidationProvider :name="'radio_field_placeholder'+counter" rules="required" v-slot="{ errors }">
                            <b-form-input name="radio_field_placeholder[]" placeholder="Placeholder for the input" 
                        ...
                        label-for="radio_field_name_attribute[]">
                        <ValidationProvider :name="'radio_field_name_attribute'+counter" rules="required|alpha_dash" v-slot="{ errors }">
                            <b-form-input name="radio_field_name_attribute[]" placeholder="Name attribute for the input"  
